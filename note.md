...
# copy file từ container, chạy xong xóa luôn container, lưu ý path window thì cần chuyển từ "\" sang "/"
docker run -it --rm -v /[path position save]/:/[path file in container]/ [images] cp [file need copy ] /[path file in container]//
+ ex: docker run -it --rm -v D:/wordpress_nginx_ubuntu20.04/:/home/ wordpress-ubuntu20.04:v5 cp /etc/mysql/mariadb.conf.d/50-server.cnf /home/
